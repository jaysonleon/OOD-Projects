...
/**
 * Represents the primary model interface for playing a game of cs3500.klondike.Klondike.
 */
public interface KlondikeModel {
  /**
   * Return a valid and complete deck of cards for a game of cs3500.klondike.Klondike.
  ...
  /**
   * <p>Deal a new game of cs3500.klondike.Klondike.
   ...
   * @throws IllegalStateException if the game hasn't been started yet
   * @throws IllegalArgumentException if the coordinates are invalid, or if the card is not visible
   */
